...
/// </summary>
/// <typeparam name="TUser">A user class implementing <see cref="IHashedNormalizationUser"/>.</typeparam>
public class DataProtectionLookupProtectedUserManager<TUser>(
...
{
    /// <summary>
    /// Hashes the provided data using a user's normalization salt if personal data protection is enabled.
    /// </summary>
